...
resource "azurerm_app_service" "my_app_service_container" {
    ...
    app_settings = {
        ...
        MONGO_CONNECTION_STRING = "mongodb://${azurerm_cosmosdb_account.acc.name}:${azurerm_cosmosdb_account.acc.primary_key}@${azurerm_cosmosdb_account.acc.name}.mongo.cosmos.azure.com:10255/DefaultDatabase?ssl=true&replicaSet=globaldb&retrywrites=false&maxIdleTimeMS=120000"
